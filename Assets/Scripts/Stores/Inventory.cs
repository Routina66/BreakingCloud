...
public class Inventory : GameStore {
    ...
    public override PlayObject GetPlayObject(PlayObjectData objectData) {
        var theObject = playObjects.Find(playObject => playObject.Data.Equals(objectData));//o => o.Identifier.Equals(objectData.Identifier));
        ...
        if (theObject != null) {
            ...
            OnPlayObjectRemoved.Invoke(theObject.Data);
        }
