...
public abstract class GameStore : MonoBehaviour {
    ...
    public UnityEvent<MoneyType, int> OnMoneyChanged;
    [Tooltip("Sends the data of the added object.")]
    public UnityEvent<PlayObjectData> OnPlayObjectAdded;
    [Tooltip("Sends thte data of removed object.")]
    public UnityEvent<PlayObjectData> OnPlayObjectRemoved;
    #endregion
    ...
    public int AddMoney(MoneyType moneyType, int amount) {
        ...
        if (storeMoney != null) {
            ...
            OnMoneyChanged.Invoke(moneyType, storeMoney.Amount);
    ...
    public virtual void AddPlayObject(PlayObject newObject) {
        ...
        OnPlayObjectAdded.Invoke(newObject.Data);
    }
    ...
    /// <summary>
    /// The the pley objects and the money.
    /// </summary>
